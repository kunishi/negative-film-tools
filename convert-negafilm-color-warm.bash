...
convert ${BASE}_r.mpc -contrast-stretch 0.03%,0.1% ${BASE}_clahe_r.mpc
convert ${BASE}_g.mpc -contrast-stretch 0.1%,0.1% ${BASE}_clahe_g.mpc
convert ${BASE}_b.mpc -contrast-stretch 0.1%,0.1% ${BASE}_clahe_b.mpc
