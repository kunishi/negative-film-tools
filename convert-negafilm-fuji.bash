...
convert ${BASE}_r.mpc -auto-level -auto-gamma ${BASE}_clahe_r.mpc
convert ${BASE}_g.mpc -auto-level -auto-gamma ${BASE}_clahe_g.mpc
convert ${BASE}_b.mpc -auto-level -auto-gamma ${BASE}_clahe_b.mpc
...
convert ${BASE}_clahe.mpc -define jpeg:extent=7M \
  -negate -contrast-stretch 1.2%,0.4% \
