...
convert ${BASE}_r.mpc -negate -clahe 20x20%+96+3 ${BASE}_clahe_r.mpc
convert ${BASE}_g.mpc -negate -clahe 20x20%+96+3 ${BASE}_clahe_g.mpc
convert ${BASE}_b.mpc -negate -clahe 20x20%+96+3 ${BASE}_clahe_b.mpc
